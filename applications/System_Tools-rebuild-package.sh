...
elapsed-time() {
    if [ "$ELAPSED_TIME" -lt "60" ]; then
        pydialog --icon=/usr/share/icons/hicolor/scalable/apps/ks-rebuild-rpm.svgz --title="Rebuild RPM Package" --passivepopup="[Finished]. Compilation Time: ${ELAPSED_TIME}s" 2> /dev/null
    elif [ "$ELAPSED_TIME" -gt "59" ] && [ "$ELAPSED_TIME" -lt "3600" ]; then
        ELAPSED_TIME=$(echo "$ELAPSED_TIME/60"|bc -l|sed 's/...................$//')
        pydialog --icon=/usr/share/icons/hicolor/scalable/apps/ks-rebuild-rpm.svgz --title="Rebuild RPM Package" --passivepopup="[Finished]. Compilation Time: ${ELAPSED_TIME}m" 2> /dev/null
    elif [ "$ELAPSED_TIME" -gt "3599" ] && [ "$ELAPSED_TIME" -lt "86400" ]; then
        ELAPSED_TIME=$(echo "$ELAPSED_TIME/3600"|bc -l|sed 's/...................$//')
        pydialog --icon=/usr/share/icons/hicolor/scalable/apps/ks-rebuild-rpm.svgz --title="Rebuild RPM Package" --passivepopup="[Finished]. Compilation Time: ${ELAPSED_TIME}h" 2> /dev/null
    elif [ "$ELAPSED_TIME" -gt "86399" ]; then
        ELAPSED_TIME=$(echo "$ELAPSED_TIME/86400"|bc -l|sed 's/...................$//')
        pydialog --icon=/usr/share/icons/hicolor/scalable/apps/ks-rebuild-rpm.svgz --title="Rebuild RPM Package" --passivepopup="[Finished]. Compilation Time: ${ELAPSED_TIME}d" 2> /dev/null
    fi
}
...
rpmbuild-error() {
    if [ "$?" != "0" ]; then
        ...
        pydialog --icon=/usr/share/icons/hicolor/scalable/apps/ks-rebuild-rpm.svgz --title="Rebuild RPM Package" \
...
rpmmacros-no-cflags() {
    ...
    pydialog --icon=/usr/share/icons/hicolor/scalable/apps/ks-rebuild-rpm.svgz --title="Rebuild RPM Package | B.O.O.=\"$BINOPT\"" \
    ...
    if [ "$?" != "0" ]; then
        BINOPT=$(pydialog --icon=/usr/share/icons/hicolor/scalable/apps/ks-rebuild-rpm.svgz --title="Rebuild RPM Package" --combobox="Choose Binary Optimization Option(s)" \
...
notify() {
    if [ "$EXIT" = "0" ]; then
        pydialog --icon=/usr/share/icons/hicolor/scalable/apps/ks-rebuild-rpm.svgz --title="Rebuild RPM Package" --passivepopup="Install $APPNAME   [Finished]" 2> /dev/null
    else
        pydialog --icon=/usr/share/icons/hicolor/scalable/apps/ks-error.svgz --title="Rebuild RPM Package" --passivepopup="Install $APPNAME   [Error]: See debug console." \
                       2> /dev/null
    fi
}
...
install-package() {
    ...
    if [ ! -s package.tmp ]; then
        ...
        play /tmp/speak.wav 2> /dev/null
        rm -fr /tmp/speak*
        pydialog --icon=/usr/share/icons/hicolor/scalable/apps/ks-rebuild-rpm.svgz --title="Rebuild RPM Package" --error="No packages for install. Try Again." 2> /dev/null
        exit 0
    fi
    ...
    INSTALLPKG=$(pydialog --icon=/usr/share/icons/hicolor/scalable/apps/ks-rebuild-rpm.svgz --title="Rebuild RPM Package" --separate-output \
...
PACKAGESOURCE=$(pydialog --icon=/usr/share/icons/hicolor/scalable/apps/ks-rebuild-rpm.svgz --title="Rebuild RPM Package" --yesnocancel "Have the source RPM package?" 2> /dev/null)
EXIT=$?
if-cancel-exit
...
if [ "$EXIT" = "1" ]; then
    ...
    APPNAME=$(pydialog --icon=/usr/share/icons/hicolor/scalable/apps/ks-rebuild-rpm.svgz --title="Rebuild RPM Package" --separate-output \
    ...
    if [ "$(echo $APPNAME|xargs)" = "All Other" ]; then
        pydialog --icon=/usr/share/icons/hicolor/scalable/apps/ks-error.svgz --title="Rebuild RPM Package" --passivepopup="[Error]: Please select All-List or Other, not both." \
                       2> /dev/null
    ...
    if [ "$APPNAME" = "Other" ]; then
        APPNAME=$(pydialog --icon=/usr/share/icons/hicolor/scalable/apps/ks-rebuild-rpm.svgz --title="Rebuild RPM Package" \
    ...
    for i in $APPNAME; do
        ...
        if [ "$?" != "0" ]; then
            ...
            pydialog --icon=/usr/share/icons/hicolor/scalable/apps/ks-error.svgz --title="Rebuild RPM Package" \
...
if [ "$EXIT" = "0" ]; then
    SOURCEFILE=$(pydialog --icon=/usr/share/icons/hicolor/scalable/apps/ks-rebuild-rpm.svgz --title="Rebuild RPM Package - Source RPM File" --multiple \
