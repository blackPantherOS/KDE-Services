...
progressbar-start() {
    DBUSREF=$(pydialog --icon=/usr/share/icons/hicolor/scalable/apps/ks-media-optical-burn.svgz --title="Burn iso9660 Image" --progressbar "                                  " /ProcessDialog)
}
...
cd "${1%/*}"
BURNSPEED=$(pydialog --icon=/usr/share/icons/hicolor/scalable/apps/ks-media-optical-burn.svgz --title="Burn iso9660 Image" \
...
if [ "$ELAPSED_TIME" -lt "60" ]; then
    pydialog --icon=/usr/share/icons/hicolor/scalable/apps/ks-media-optical-burn.svgz --title="Burn iso9660 Image" \
